...
```{r traceplot, fig.cap = "<span style='color: #d3d3d3;'>Traceplots of the proposal effects of all 18 proposals in the Biology panel for the Postdoc.Mobility fellowships.</span>", fig.height = 12, fig.width = 15, warning = FALSE, fig.align = "center", cache = TRUE}
...
Gelman et al. (2014) \citep{Gelman2014} have recommended to use $1.1$ as threshold value for $\hat{R}$.
