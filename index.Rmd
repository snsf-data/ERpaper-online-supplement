...
cat("model{
    ...
    file = here("minor_revision", "manuscript",
                "jags_model_change_nuvariance_smaller.txt"))
...
cat("model{
    ...
    file = here("minor_revision", "manuscript",
                "jags_model_change_nuvariance_larger.txt"))
...
mcmc_hss_s_object_smaller_variance <- 
  get_mcmc_samples(data = hss_s,
                   ...
                   grade_variable = "num_grade",
                   path_to_jags_model = 
                     here("minor_revision", "manuscript", 
                          "jags_model_change_nuvariance_smaller.txt"),
                   n_chains = n.chains, n_iter = n.iter,
                   n_burnin = n.burnin, n_adapt = n.adapt,
                   max_iter = max.iter,
...
cat("model{
    ...
    file = here("minor_revision", "manuscript",
                "jags_model_change_halfcauchy.txt"))
